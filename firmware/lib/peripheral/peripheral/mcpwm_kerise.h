...
#ifndef _DRIVER_MCPWM_KERISE_H_
#define _DRIVER_MCPWM_KERISE_H_
...
typedef struct {
    ...
    int mcpwm_kerise_fault0_in_num;   /*!<FAULT0 in pin*/
    int mcpwm_kerise_fault1_in_num;   /*!<FAULT1 in pin*/
    int mcpwm_kerise_fault2_in_num;   /*!<FAULT2 in pin*/
    int mcpwm_kerise_cap0_in_num;     /*!<CAP0   in pin*/
    int mcpwm_kerise_cap1_in_num;     /*!<CAP1   in pin*/
    int mcpwm_kerise_cap2_in_num;     /*!<CAP2   in pin*/
} mcpwm_kerise_pin_config_t;
...
} mcpwm_kerise_carrier_out_ivt_t;
...
} mcpwm_kerise_fault_input_level_t;
...
} mcpwm_kerise_action_on_pwmxa_t;
...
} mcpwm_kerise_action_on_pwmxb_t;
...
} mcpwm_kerise_capture_on_edge_t;
...
typedef struct {
    ...
    mcpwm_kerise_duty_type_t duty_mode;     /*!<Set type of duty cycle*/
    mcpwm_kerise_counter_type_t counter_mode;  /*!<Set  type of MCPWM counter*/
} mcpwm_kerise_config_t;
...
typedef struct {
    ...
    mcpwm_kerise_carrier_os_t carrier_os_mode;        /*!<Enable or disable carrier oneshot mode*/
    mcpwm_kerise_carrier_out_ivt_t carrier_ivt_mode;  /*!<Invert output of carrier*/
} mcpwm_kerise_carrier_config_t;
 ...
 *
 * @param mcpwm_kerise_num set MCPWM unit(0-1)
 ...
 *
 * @param mcpwm_kerise_num set MCPWM unit(0-1)
 * @param mcpwm_kerise_pin MCPWM pin structure
 *
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Parameter error
 ...
 * @param mcpwm_kerise_conf configure structure mcpwm_kerise_config_t
 *
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Parameter error
 ...
 *        @note
 *        Call this function every time after mcpwm_kerise_set_signal_high or mcpwm_kerise_set_signal_low to resume with previously set duty cycle
 *
 * @param mcpwm_kerise_num set MCPWM unit(0-1)
 * @param timer_num set timer number(0-2) of MCPWM, each MCPWM unit has 3 timers
 * @param op_num set the operator(MCPWMXA/MCPWMXB), 'x' is timer number selected
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t mcpwm_kerise_set_duty_type(mcpwm_kerise_unit_t mcpwm_kerise_num, mcpwm_kerise_timer_t timer_num, mcpwm_kerise_operator_t op_num, mcpwm_kerise_duty_type_t duty_num);
 ...
 * @param mcpwm_kerise_num set MCPWM unit(0-1)
 * @param timer_num set timer number(0-2) of MCPWM, each MCPWM unit has 3 timers
 * @param carrier_conf configure structure mcpwm_kerise_carrier_config_t
 *
 * @return
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Parameter error
