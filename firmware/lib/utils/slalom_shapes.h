...
static const auto SS_FLS90 = ctrl::slalom::Shape(ctrl::Position(45, 45, 1.5708), ctrl::Position(44.0134, 44.0073, 1.5708), 0.986565, 0.992722, 265.761); //< T: 0.287448 [s]
static const auto SS_FRS90 = ctrl::slalom::Shape(ctrl::Position(45, -45, -1.5708), ctrl::Position(44.0134, -44.0073, -1.5708), 0.986565, 0.992722, 265.761); //< T: 0.287448 [s]
